...
def start():
    ...
    angles_east_to_south=np.arange(0,num)*step+start

    print(angles_east_to_south)


    for i in range(0,len(angles_east_to_south)):
        for v in range(0,len(range_of_speeds)):
            main(angles_east_to_south[i],range_of_speeds[v])
