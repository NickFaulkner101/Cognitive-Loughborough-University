...
# for each turbine pair
#calculate the distance between them
#calculate the Jensen Speed between them
...
# we already have it for every turbine.
# he wants us to plot it using the distance check for each individual turbine, with several lines