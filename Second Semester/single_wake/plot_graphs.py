...
def residuals(x,y,Turbine_A,Turbine_B):
    ...
    plt.title("Q-Q Plot of Residuals from Polynomial Fit of Power Data")
    plt.grid()
    plt.show()
...
#6 order polynomial
    ...
    plt.xlabel('Turbine A Power (kW)')
    plt.ylabel('Turbine B Power (kW)')
    plt.title("Jensen-Predicted Power vs 3^rd Order Polynomial Regressor ")
    plt.grid()
    plt.show()
